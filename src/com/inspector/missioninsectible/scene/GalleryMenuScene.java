...
public class GalleryMenuScene extends Scene {
	...
	public GalleryMenuScene(){
		...
		this.mFontSec = new Font(activity.getFontManager(), this.mFontTexture, Typeface.create(Typeface.DEFAULT, Typeface.NORMAL), 24, true, Color.BLACK);
		...
		mTextSec = new Text(activity.mCamera.getWidth()/2+90, activity.mCamera.getHeight()-90, mFontSec, "sec", 3, activity.getVertexBufferObjectManager());
